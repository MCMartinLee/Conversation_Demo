...
```
- Download the [release](https://github.com/MCMartinLee/Conversation_Demo/releases/latest) and extract it, then move `Release\Conversation' and 'Release\Resources' to the repo.
- Click on Demo.sln and start the project.

## Execution
Download the [release](https://github.com/MCMartinLee/Conversation_Demo/releases/latest) and extract it, then launch `Release/Release/Demo.exe`
